...
from cognitopy.schemas import UserRegister, CodeDeliveryDetails
...
class TestCognito(TestCase):
    ...
    def test_dict_to_cognito_error_dict(self):
        ...
        self.assertEqual(str(exc.exception), 'The key attributes should be a dictionary and value should be a '
                                             'string or number')
    ...
    def test_dict_to_cognito_error_type_value(self):
        ...
        self.assertEqual(str(exc.exception), 'attributes should be a dictionary.')
    ...
    def test_register_error_type_user_attributes(self, mock_client: Mock):
        ...
        self.assertEqual(
            str(exc.exception), 'The username and password should be strings, user_attributes and validation_data should be a dict.'
        )
