...
class TestCognito(TestCase):
    ...
    def test_dict_to_cognito(self):
        ...
        self.assertEqual([
            {'Name': 'atb_test1', 'Value': 'value1'}, {'Name': 'atb_test2', 'Value': 'value2'},
            {'Name': 'atb_test3', 'Value': 'false'}], response)
    ...
    def test_dict_to_cognito_error_dict(self):
        ...
        self.assertEqual('The key attributes should be a dictionary and value should be a string or number',
                         str(exc.exception))
    ...
    def test_register_with_secret_hash(self, mock_client: Mock):
        ...
        mock_sign_up.return_value = {'UserConfirmed': False, 'UserSub': 'test1232',
                                     'CodeDeliveryDetails': {'Destination': 'd***@g***', 'DeliveryMedium': 'EMAIL',
                                                             'AttributeName': 'email'}}
        expected_calls = [
            call(
                ClientId='dtest34453',
        ...
        expected_response = UserRegister(UserConfirmed=False, UserSub='test1232',
                                         CodeDeliveryDetails=CodeDeliveryDetails(Destination='d***@g***',
    ...
    def test_register_error(self, mock_client: Mock):
        ...
        expected_calls = [
            call(
                ...
                Username='username_test',
                Password='password_test',
                UserAttributes=[{'Name': 'email', 'Value': 'email_test'}], ValidationData=[]
            )
        ]
    ...
    def test_register_error_type_user_attributes(self, mock_client: Mock):
        ...
        self.assertEqual('The username and password should be strings, user_attributes and validation_data should be a '
                         'dict.',str(exc.exception))
    ...
    def test_resend_confirmation_code(self, mock_client: Mock):
        ...
        mock_resend_confirmation_code.side_effect = [{'CodeDeliveryDetails':  {'Destination': 'd***@g***',
                                                                               'DeliveryMedium': 'EMAIL',
                                                                               'AttributeName': 'email'}}]
        expected_response = (CodeDeliveryDetailsSchema
                             (CodeDeliveryDetails=CodeDeliveryDetails(Destination='d***@g***', DeliveryMedium='EMAIL',
                                                                      AttributeName='email')))
